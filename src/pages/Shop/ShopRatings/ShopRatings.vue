<template>
  <div class="ratings" ref="ratings">
    <div class="ratings-content">
      ...
      <div class="split"></div>
      <!-- 点击 0 1 2 显示不同的评论数据，通过 0 1 3 进行判断显示那个数据  -->
...
export default {
    ...
    data () {
      return {
        onlyShowText: true, // 是否只显示有文本的数据，true只看有没有文本内容
        selectType: 2 , // 选择的评价类型: 0满意, 1不满意, 2全部，点击显示不同的数据
      }
    },
    mounted () {
      // 获取数据
        ...
        return ratings.filter(rating => {
          ...
          /*
            ...
            条件2
                ...
                text: 有值/没值
                如果为false 就不要text有没有值
                如果为 true 就看 text值。要求length大于0
